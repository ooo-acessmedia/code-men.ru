...
module.exports = function (grunt) {
    ...
    var deployServer = '31.31.196.102',
        deployFolder = 'code-men.ru',
        liveReloadFolder = 'http://code-men.ru/';
    ...
    grunt.initConfig({
        ...
        'ftp-deploy': {
            css: {
                ...
                dest: 'www/' + deployFolder + '/assets/templates/css/',
            ...
            js: {
                ...
                dest: 'www/' + deployFolder + '/assets/templates/js/',
            ...
            images: {
                ...
                dest: 'www/' + deployFolder + '/assets/templates/img/'
            },
            ...
            'js-minishop': {
                ...
                dest: 'www/' + deployFolder + '/assets/components/minishop2/js/web/'
            }
